...
*/
	{
		...
		qa_report_event('q_edit', $userid, $handle, $cookieid, $eventparams);
...
*/
	{
		...
		if ( $wasqueued && (!$hidden) && qa_opt('moderate_update_time') ) { // ... for approval of a post, can set time to now instead			
		...
		if ($wasqueued && (!$hidden) && !$wasrequeued) {
...
*/
	{
		...
		qa_report_event('a_edit', $userid, $handle, $cookieid, $eventparams);
...
*/
	{
		...
		qa_report_event('c_edit', $userid, $handle, $cookieid, $eventparams);
...
*/
	{
		...
		qa_report_event('a_to_c', $userid, $handle, $cookieid, $eventparams);
