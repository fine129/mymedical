...
*/
	...
	//	Cache some responses to the user permission checks
		...
		$permiterror_flag=qa_user_permit_error('permit_flag');
...
*/
	{
		...
		$q_view['buttons_form_hidden']=array('code' => qa_get_form_security_code('buttons-'.$questionid));
...
*/
	{
		...
		$a_view['buttons_form_hidden']=array('code' => qa_get_form_security_code('buttons-'.$answerid));
...
*/
	...
	function qa_page_q_add_a_form(&$qa_content, $formid, $captchareason, $questionid, $in, $errors, $loadnow, $formrequested)
/*
...
*/
			...
			case false:
				...
				$form=array(
					...
					'hidden' => array(
						...
						'a_doadd' => '1',
						'code' => qa_get_form_security_code('answer-'.$questionid),
					),
				);
	...
	function qa_page_q_add_c_form(&$qa_content, $questionid, $parentid, $formid, $captchareason, $in, $errors, $loadfocusnow)
/*
			...
			case false:
				...
				$form=array(
					...
					'hidden' => array(
						...
						$prefix.'doadd' => '1',
						$prefix.'code' => qa_get_form_security_code('comment-'.$parentid),
					),
				);
